...
export function loadCounter$Data(slice: Slice) {
    ...
    return { $$type: 'Counter$Data' as const, id: _id, counter: _counter };
}
...
async function Counter_init(id: bigint) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
...
const Counter_types: ABIType[] = [
    ...
    {"name":"Counter$Data","header":null,"fields":[{"name":"id","type":{"kind":"simple","type":"uint","optional":false,"format":32}},{"name":"counter","type":{"kind":"simple","type":"uint","optional":false,"format":32}}]},
]
